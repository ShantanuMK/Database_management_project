...
session_start();
  ...
  if (isset($_REQUEST['delete'])) {
        $sql="DELETE FROM sellers where sid = {$_REQUEST['id']}";
        $res=mysqli_query($conn,$sql);
        $sql1="DELETE from product_stock where sid = {$_REQUEST['id']}";
              ...
              <table class="table">
                ...
                <tbody>
                    ...
                    while ($row=mysqli_fetch_array($result)) {
                      ...
                      echo '<td class="addrress">' . $s_add . '</td>';
                    
                      echo '<td class="total">' . $s_num . '</td>';
                    
                    
                      echo '<td class="email">' . $s_email . '</td>';
                      echo '</tr>' ;
