...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <p><span>Orders in Process</span></p>
      <section class="ftco-section ftco-cart">
    	...
    	<tbody>
    		...
    		<?php
    			$conn=mysqli_connect("localhost","root","","vegetable");
    			$get="select o.oid,o.date,o.bid,o.pid,o.sid,p.pname,s.sname,s.snum, o.pquantity, o.ptotal_price, p.pimage, o.status from orders o , products p, sellers s where o.pid=p.pid AND o.sid=s.sid AND o.bid={$_SESSION['bid']} AND o.status='In Process'";
 ...
 <p><span>Orders Completed</span></p>
      <section class="ftco-section ftco-cart">
			<div class="container">
				<div class="row">
    			<div class="col-md-12 ftco-animate">
    	...
    	<tbody>
    		...
    		<?php
    			$conn=mysqli_connect("localhost","root","","vegetable");
    			$get="select o.oid,o.date,o.bid,o.pid,o.sid,p.pname,s.sname,s.snum, o.pquantity, o.ptotal_price, p.pimage, o.status from orders o , products p, sellers s where o.pid=p.pid AND o.sid=s.sid AND o.bid={$_SESSION['bid']} AND o.status='Completed'";
    			$result=mysqli_query($conn,$get);
    			while($row=mysqli_fetch_array($result))
    			{
    				$ooid=$row['oid'];
