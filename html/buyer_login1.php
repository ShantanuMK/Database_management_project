...
if(isset($_POST['signup'])){
 if(empty($_POST['b_email']) || empty($_POST['b_password'])){
 ...
 $query = mysqli_query($conn, "SELECT * FROM buyers WHERE bpassword='$pass' AND bemail='$user'");
 $datab=mysqli_fetch_array($query);
 $rows = mysqli_num_rows($query);
 if($rows == 1){
 $_SESSION['bid']=$datab["bid"];
 $_SESSION['bname']=$datab["bname"];
        ...
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
            <form action="#" class="billing-form" method="post">
              <h3 class="mb-4 billing-heading">Buyer Login</h3>
              <div class="row align-items-end">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="firstname">User ID</label>
                    <input type="text" class="form-control" placeholder=" Your email is uesrId" name="b_email">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="firstname">Password</label>
                    <input type="text" class="form-control" placeholder="" name="b_password">
                  </div>
                </div>
                <br>  
                <br>  
