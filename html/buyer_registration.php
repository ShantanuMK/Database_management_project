...
<html lang="en">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
            <form action="buyer_registration.php" method="post" class="billing-form">
              <h3 class="mb-4 billing-heading">Buyer Registration</h3>
              <div class="row align-items-end">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="firstname">Name</label>
                    <input type="text" class="form-control" placeholder="Enter Your Name" name="b_name" required>
                  </div>
                </div>
                <div class="w-100"></div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Your Address" name="b_address" required>
                  </div>
                </div>
                <div class="w-100"></div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter your Number" name="b_num" value='' min='1' max='10000000000' required>
                  </div>
                </div>
                <div class="w-100"></div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter your Email address" name="b_email" required>
                  </div>
                </div>
                <div class="w-100"></div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Create your password" name="b_pass" required>
                  </div>
                </div>
                <div class="w-100"></div>
  ...
  {
    $bbname=$_POST['b_name'];
    $bbadd=$_POST['b_address'];
    $bbnum=$_POST['b_num'];
    $bbemail=$_POST['b_email'];
    $bbpass=$_POST['b_pass'];
   ...
   // echo $bbname;
    ...
    //$query="INSERT INTO `buyers`(`bname`, `badd`, `bnum`, `bemail`, `bpassword`) VALUES ('$bbname','$bbadd','$bbnum','$bbemail','$bbpass')";
   // $query="INSERT into 'buyers'(bname,badd,bum,bemail,bpassword) values '$bbname','$bbadd',$bbnum,'$bbemail','$bbpass')";
   //$query="INSERT INTO `buyers`(`bname`, `badd`, `bnum`, `bemail`, `bpassword`) VALUES ('$bbname','$bbadd','$bbnum','$bbemail','$bbpass')";
   //$insert_query=mysqli_query($conn,$query);

    //$insert_query="into buyers (bname,badd,bum,bemail,bpassword) values ('$bbname','$bbadd',$bbnum,'$bbemail','$bbpass')";
   mysqli_query($conn,"INSERT INTO buyers(bname,badd,bnum,bemail,bpassword) VALUES ('$bbname','$bbadd',$bbnum,'$bbemail','$bbpass')");
