    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-14 ftco-animate">
              <h1 class="mb-4 billing-heading">Welcome <?php echo $_SESSION['sname'];?></h1>
              <div class="row align-items-end">
                <p><a href="seller_stock.php"class="btn btn-primary py-3 px-4">Update Stock</a></p>
      
                <p><a href="seller_orders.php"class="btn btn-primary py-3 px-4">View Recieved Orders</a></p>
