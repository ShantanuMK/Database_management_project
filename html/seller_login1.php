...
if(isset($_POST['signup'])){
 ...
 $query = mysqli_query($conn, "SELECT * FROM sellers WHERE spass='$pass' AND semail='$user'");
 $datas=mysqli_fetch_array($query);
 $rows = mysqli_num_rows($query);
 if($rows == 1){
  $_SESSION['sid']=$datas["sid"];
  $_SESSION['sname']=$datas["sname"];
 header("Location: seller_login.php"); // Redirecting to other page
 }
 else
 {
              ...
              <div class="row align-items-end">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="" name="s_email">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="firstname">Password</label>
                    <input type="text" class="form-control" placeholder="" name="s_password">
                  </div>
                </div>
                <br>  
                <br>  
