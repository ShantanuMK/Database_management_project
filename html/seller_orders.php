<?php
  ...
  if (isset($_POST['Confirm_Delivery'])) {
      $ddid=$_POST['oooid'];
      $run_delivery="update orders set status='Completed' where oid=$ddid";
      $run_query=mysqli_query($conn,$run_delivery);
    }
...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <p><span><h5>Recieved Orders</h5></span></p>
      ...
      <tbody>
        ...
        <?php
          $conn=mysqli_connect("localhost","root","","vegetable");
          $get="select o.oid,o.date,o.bid,o.pid,o.sid,p.pname,b.bname,b.bnum,p.pimage, o.pquantity, o.ptotal_price, b.badd , o.status from orders o , products p, buyers b where o.pid=p.pid AND o.bid=b.bid AND o.sid={$_SESSION['sid']} AND o.status='In Process'";
          ...
          while($row=mysqli_fetch_array($result))
          {
            ...
            echo '<td>
                      ...
                      <input type="hidden" name="oooid" value=' . $row["oid"] . '>
                      <input type="submit" class="btn btn-primary py-3 px-4" name="Confirm_Delivery" value="Confirm_Delivery"></td>
                      </form>';
            echo "</tr>";
          }
        ?>
  ...
  <p><span><h5>Delivered Orders</h5></span></p>
      <section class="ftco-section ftco-cart">
      <div class="container">
        <div class="row">
          <div class="col-md-12 ftco-animate">
      ...
      <tbody>
        ...
        <?php
          $conn=mysqli_connect("localhost","root","","vegetable");
          $get="select o.oid,o.date,o.bid,o.pid,o.sid,p.pname,b.bname,b.bnum,p.pimage, o.pquantity, o.ptotal_price, b.badd , o.status from orders o , products p, buyers b where o.pid=p.pid AND o.bid=b.bid AND o.sid={$_SESSION['sid']} AND o.status='Completed'";
          $result=mysqli_query($conn,$get);
          while($row=mysqli_fetch_array($result))
          {
            $ooid=$row['oid'];
